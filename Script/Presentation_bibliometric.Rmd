...
set.seed(9001)
net=netPlot(BC1_mat, n = 30, Title = "Bibliographic Copling Network, 2000-2007", 
...
set.seed(90001)
net=netPlot(BC2_mat, n = 30, Title = "Bibliographic Copling Network, 2008-2015", 
...
set.seed(690001)
net=netPlot(BC3_mat, n = 30, Title = "Bibliographic Copling Network, 2016-2022", 
            type = "fruchterman", size.cex=TRUE, size=15, 
            remove.multiple=FALSE, labelsize=0.7,edgesize = 4, edges.min=1, label = T,
            cluster = "louvain")
